...
public class Chunk
{
    ...
    {
        this.storageArrays = new ExtendedBlockStorage[4096];
        ...
        this.entityLists = (ClassInheritanceMultiMap[])(new ClassInheritanceMultiMap[4096]); //16?
    ...
    {
        int i = this.heightMap[z << 4 | x] & 65535;
        int j = i;
    ...
    public boolean getAreLevelsEmpty(int startY, int endY)
    {
        ...
        if (endY >= net.minecraft.world.World.heightLimit)
        {
            endY = net.minecraft.world.World.heightLimit-1;
        }
    ...
    public void fillChunk(PacketBuffer buf, int[] p_186033_2_, boolean p_186033_3_)
    {
        ...
        {
            if (this.storageArrays[j] != NULL_BLOCK_STORAGE && (p_186033_2_[j]) != 0)
            {
     ...
     */
    public void enqueueRelightChecks()//brokenlight
    {
    ...
    private boolean checkLight(int x, int z)
    {
        ...
        for (int j = i + 16 - 1; j > this.worldObj.getSeaLevel() || j > 0 && !flag1; --j)
        {
            ...
            if (k == net.minecraft.world.World.heightLimit-1 && blockpos$mutableblockpos.getY() < this.worldObj.getSeaLevel())
            {
                flag1 = true;
            }
