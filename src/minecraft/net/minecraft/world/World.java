...
public abstract class World implements IBlockAccess
{
    ...
    public final static int heightLimit = 65536; //net.minecraft.world.World.heightLimit
    ...
    {
        return !this.isOutsideBuildHeight(pos) && pos.getX() >= -2147483647 && pos.getZ() >= -2147483647 && pos.getX() < 2147483647 && pos.getZ() < 2147483647;
    }

    private boolean isOutsideBuildHeight(BlockPos pos)
    {
        return pos.getY() < 0 || pos.getY() >= net.minecraft.world.World.heightLimit;
    }
    ...
    {
        if (yEnd >= 0 && yStart < net.minecraft.world.World.heightLimit)
        {
            xStart = xStart >> 4;
            zStart = zStart >> 4;
            xEnd = xEnd >> 4;
    ...
    public int getLight(BlockPos pos)
    {
        ...
        {
            if (pos.getY() >= net.minecraft.world.World.heightLimit)
            {
                pos = new BlockPos(pos.getX(), net.minecraft.world.World.heightLimit-1, pos.getZ());
            }
    ...
    {
        if (pos.getX() >= -2147483647 && pos.getZ() >= -2147483647 && pos.getX() < 2147483647 && pos.getZ() < 2147483647)
        {
    ...
    public int getHeight(int x, int z)
    {
        ...
        if (x >= -2147483647 && z >= -2147483647 && x < 2147483647 && z < 2147483647)
        {
                    ...
                    if ((!flag2 || !flag3) && this.isBlockLoaded(blockpos$pooledmutableblockpos.setPos(k1, 64, l1)))
                    {
                        for (int i2 = k; i2 < l; ++i2)
                        {
                            if (!flag2 && !flag3 || i2 != l - 1)
                            {
                                if (p_191504_3_)
                                {
                                    if (k1 < -2147483647 || k1 >= 2147483647 || l1 < -2147483647 || l1 >= 2147483647)
                                    {
    ...
    public boolean canBlockFreeze(BlockPos pos, boolean noWaterAdj)
    {
        ...
        {
            if (pos.getY() >= 0 && pos.getY() < net.minecraft.world.World.heightLimit && this.getLightFor(EnumSkyBlock.BLOCK, pos) < 10)
            {
                IBlockState iblockstate = this.getBlockState(pos);
                Block block = iblockstate.getBlock();
    ...
    {
        return net.minecraft.world.World.heightLimit;
    }
    ...
    {
        return this.provider.getHasNoSky() ? 128 : net.minecraft.world.World.heightLimit;
    }
