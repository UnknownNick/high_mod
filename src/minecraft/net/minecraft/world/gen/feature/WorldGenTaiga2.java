...
public class WorldGenTaiga2 extends WorldGenAbstractTree
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= net.minecraft.world.World.heightLimit)
        {
            for (int i1 = position.getY(); i1 <= position.getY() + 1 + i && flag; ++i1)
            {
                ...
                for (int k1 = position.getX() - j1; k1 <= position.getX() + j1 && flag; ++k1)
                {
                    ...
                    {
                        if (i1 >= 0 && i1 < net.minecraft.world.World.heightLimit)
                        {
            ...
            else
            {
                ...
                if ((block == Blocks.GRASS || block == Blocks.DIRT || block == Blocks.FARMLAND) && position.getY() < net.minecraft.world.World.heightLimit - i - 1)
                {
