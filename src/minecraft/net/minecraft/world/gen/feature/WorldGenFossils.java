...
public class WorldGenFossils extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        StructureBoundingBox structureboundingbox = new StructureBoundingBox(chunkpos.getXStart(), 0, chunkpos.getZStart(), chunkpos.getXEnd(), net.minecraft.world.World.heightLimit, chunkpos.getZEnd());
        ...
        int l = net.minecraft.world.World.heightLimit;
