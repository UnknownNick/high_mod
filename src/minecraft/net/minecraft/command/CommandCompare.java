...
public class CommandCompare extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else if (structureboundingbox.minY >= 0 && structureboundingbox.maxY < net.minecraft.world.World.heightLimit && structureboundingbox1.minY >= 0 && structureboundingbox1.maxY < net.minecraft.world.World.heightLimit)
            {
