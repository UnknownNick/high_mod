        ...
        else
        {
            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                else if (entity.world != null)
                {
                    ...
                    CommandBase.CoordinateArg commandbase$coordinatearg1 = parseCoordinate(entity.posY, args[lvt_6_2_++], -net.minecraft.world.World.heightLimit, net.minecraft.world.World.heightLimit, false);
