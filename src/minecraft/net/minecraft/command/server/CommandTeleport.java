    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (entity.world != null)
            {
                ...
                CommandBase.CoordinateArg commandbase$coordinatearg1 = parseCoordinate(vec3d.yCoord, args[j++], -net.minecraft.world.World.heightLimit, net.minecraft.world.World.heightLimit , false);
