        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (structureboundingbox.minY >= 0 && structureboundingbox.maxY < net.minecraft.world.World.heightLimit && structureboundingbox1.minY >= 0 && structureboundingbox1.maxY < net.minecraft.world.World.heightLimit)
                    {
