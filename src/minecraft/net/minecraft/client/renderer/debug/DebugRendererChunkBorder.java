...
public class DebugRendererChunkBorder implements DebugRenderer.IDebugRenderer
{
    ...
    public void render(float p_190060_1_, long p_190060_2_)
    {
        ...
        double d3 = 0.0D - d1;
        double d4 = (double)net.minecraft.world.World.heightLimit - d1;
        ...
        for (int i = -16; i <= 32; i += 16)
        {
            for (int j = -16; j <= 32; j += 16)
            {
                ...
                vertexbuffer.pos(d5 + (double)i, d3, d6 + (double)j).color(1.0F, 0.0F, 0.0F, 1F).endVertex();
                vertexbuffer.pos(d5 + (double)i, d4, d6 + (double)j).color(1.0F, 0.0F, 0.0F, 1F).endVertex();
        ...
        for (int i1 = 0; i1 <= net.minecraft.world.World.heightLimit; i1 += 2)
        {
        ...
        for (int k1 = 0; k1 <= (net.minecraft.world.World.heightLimit/16 )*16; k1 += 16)
        {
