...
public class SPacketMultiBlockChange implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketMultiBlockChange(int p_i46959_1_, int[] p_i46959_2_, Chunk p_i46959_3_)
    {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (int i = 0; i < this.changedBlocks.length; ++i)
        {
            this.changedBlocks[i] = new SPacketMultiBlockChange.BlockUpdateData(buf.readInt(), (IBlockState)Block.BLOCK_STATE_IDS.getByValue(buf.readVarIntFromBuffer()));
        }
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        {
            buf.writeInt(spacketmultiblockchange$blockupdatedata.getOffset());
    ...
    {
        private final int offset; //short > int
        private final IBlockState blockState;

        public BlockUpdateData(int p_i46544_2_, IBlockState p_i46544_3_)
        {
            this.offset = p_i46544_2_;
            this.blockState = p_i46544_3_;
        }

        public BlockUpdateData(int p_i46545_2_, Chunk p_i46545_3_)
        {
        ...
        {
            return new BlockPos(SPacketMultiBlockChange.this.chunkPos.getBlock(this.offset >> 20 & 15, this.offset & 65535, this.offset >> 16 & 15));
        }
