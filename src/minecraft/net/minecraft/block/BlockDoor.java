...
public class BlockDoor extends Block
{
    ...
    {
        return pos.getY() >= net.minecraft.world.World.heightLimit-1 ? false : worldIn.getBlockState(pos.down()).isFullyOpaque() && super.canPlaceBlockAt(worldIn, pos) && super.canPlaceBlockAt(worldIn, pos.up());
    }
