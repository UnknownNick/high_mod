...
public abstract class Entity implements ICommandSender
{
    ...
    protected void preparePlayerToSpawn()
    {
        if (this.world != null)
        {
            while (this.posY > 0.0D && this.posY < (double)net.minecraft.world.World.heightLimit)
            {
    ...
    {
        this.posX = MathHelper.clamp(x, -2147483647.0D, 2147483647.0D);
        this.posY = y;
        this.posZ = MathHelper.clamp(z, -2147483647.0D, 2147483647.0D);
        this.prevPosX = this.posX;
        this.prevPosY = this.posY;
        this.prevPosZ = this.posZ;
    ...
    public Entity changeDimension(int dimensionIn)
    {
        if (!this.world.isRemote && !this.isDead)
        {
            ...
            else
            {
                ...
                d0 = (double)MathHelper.clamp((int)d0, -2147483394, 2147483394);
                d1 = (double)MathHelper.clamp((int)d1, -2147483394, 2147483394);
